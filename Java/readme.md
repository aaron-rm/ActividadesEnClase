...
| Proyecto / Lab | Temática Principal | Lenguajes |
| :--- | :--- | :--- |
| **Biblioteca Univ.** | Registros, Arreglos y CRUD | C++ / Java |
| **Lab 4: Decisiones** | Lógica condicional anidada | C / Python |
| **Lab 5: Ciclos** | Bucles y Nómina de empleados | C / Java |
| **Actividad: Objetos** | Modelado administrativo y lógico | UML / OOP |
